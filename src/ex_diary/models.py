...
class ExDiary(Base):
    ...
    weather: Mapped[WeatherEnum] = Column(
        Enum(WeatherEnum, name="ex_weatherenum"), nullable=False
    )
    mood: Mapped[MoodEnum] = Column(Enum(MoodEnum, name="ex_moodenum"), nullable=False)
